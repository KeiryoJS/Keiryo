...
import { Collection, PermissionResolvable, Permissions } from "@neocord/utils";
import { Resource } from "../../../abstract/Resource";
import { parseColor } from "../../../../utils";

import type { APIRole, APIRoleTags } from "discord-api-types";
...
export class Role extends Resource {
  ...
  public async edit(data: ModifyRoleData, reason?: string): Promise<this> {
    ...
    const modified = await this.client.rest.patch<APIRole>(
   ...
   */
  public async addTo(target: MemberLike, reason?: string): Promise<this> {
   ...
   * @returns {Promise<Role>}
   */
  public async removeFrom(target: MemberLike, reason?: string): Promise<this> {
    const member = this.guild.members.resolve(target);
    if (member) {
