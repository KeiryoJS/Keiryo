...
export type JanitorJobs = Map<DiscordStructure, typeof Job> | Partial<Record<DiscordStructure, typeof Job>>;
...
export class Job<O extends JobOptions = JobOptions> {
   ...
   * @type {Set<Cache>}
   */
  readonly caches: Set<Cache<Base>>;
  /**
